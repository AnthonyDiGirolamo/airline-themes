...
(deftheme airline-base16_espresso
...
(let ((normal-outer-foreground   "#393939") (normal-outer-background   "#b4b7b4")
      ...
      (insert-outer-foreground   "#393939") (insert-outer-background   "#a5c261")
      ...
      (visual-outer-foreground   "#393939") (visual-outer-background   "#f9a959")
      ...
      (replace-outer-foreground  "#393939") (replace-outer-background  "#d197d9")
  ...
  (airline-themes-set-deftheme 'airline-base16_espresso)
...
(provide-theme 'airline-base16_espresso)
;;; airline-base16_espresso-theme.el ends here
