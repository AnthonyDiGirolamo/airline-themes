...
(deftheme airline-base16_tomorrow_night_eighties
...
(let ((normal-outer-foreground   "#393939") (normal-outer-background   "#b4b7b4")
      ...
      (insert-outer-foreground   "#393939") (insert-outer-background   "#99cc99")
      ...
      (visual-outer-foreground   "#393939") (visual-outer-background   "#f99157")
      ...
      (replace-outer-foreground  "#393939") (replace-outer-background  "#cc99cc")
  ...
  (airline-themes-set-deftheme 'airline-base16_tomorrow_night_eighties)
...
(provide-theme 'airline-base16_tomorrow_night_eighties)
;;; airline-base16_tomorrow_night_eighties-theme.el ends here
