...
(deftheme airline-base16_horizon_dark
...
(let ((normal-outer-foreground   "#232530") (normal-outer-background   "#9DA0A2")
      ...
      (insert-outer-foreground   "#232530") (insert-outer-background   "#EFAF8E")
      ...
      (visual-outer-foreground   "#232530") (visual-outer-background   "#E58D7D")
      ...
      (replace-outer-foreground  "#232530") (replace-outer-background  "#B072D1")
  ...
  (airline-themes-set-deftheme 'airline-base16_horizon_dark)
...
(provide-theme 'airline-base16_horizon_dark)
;;; airline-base16_horizon_dark-theme.el ends here
