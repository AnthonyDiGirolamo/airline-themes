...
(deftheme airline-base16_black_metal_gorgoroth
...
(let ((normal-outer-foreground   "#121212") (normal-outer-background   "#999999")
      ...
      (insert-outer-foreground   "#121212") (insert-outer-background   "#9b8d7f")
  ...
  (airline-themes-set-deftheme 'airline-base16_black_metal_gorgoroth)
...
(provide-theme 'airline-base16_black_metal_gorgoroth)
;;; airline-base16_black_metal_gorgoroth-theme.el ends here
