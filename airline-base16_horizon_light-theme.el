...
(deftheme airline-base16_horizon_light
...
(let ((normal-outer-foreground   "#FADAD1") (normal-outer-background   "#948C8A")
      ...
      (insert-outer-foreground   "#FADAD1") (insert-outer-background   "#94E1B0")
      ...
      (visual-outer-foreground   "#FADAD1") (visual-outer-background   "#F6661E")
      ...
      (replace-outer-foreground  "#FADAD1") (replace-outer-background  "#1D8991")
  ...
  (airline-themes-set-deftheme 'airline-base16_horizon_light)
...
(provide-theme 'airline-base16_horizon_light)
;;; airline-base16_horizon_light-theme.el ends here
