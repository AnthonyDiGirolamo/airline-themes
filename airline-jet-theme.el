...
(let ((normal-outer-foreground   "#d8dee9") (normal-outer-background   "#0d61ac")
      ...
      (insert-inner-foreground   "#4f5b66") (insert-inner-background   "#262626")
      ...
      (visual-inner-foreground   "#4f5b66") (visual-inner-background   "#262626")
      ...
      (replace-inner-foreground  "#4f5b66") (replace-inner-background  "#262626")
...
(provide-theme 'airline-jet)
;;; airline-jet-theme.el ends here
