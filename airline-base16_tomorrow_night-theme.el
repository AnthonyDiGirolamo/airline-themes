...
(deftheme airline-base16_tomorrow_night
...
(let ((normal-outer-foreground   "#282a2e") (normal-outer-background   "#b4b7b4")
      ...
      (insert-outer-foreground   "#282a2e") (insert-outer-background   "#b5bd68")
      ...
      (visual-outer-foreground   "#282a2e") (visual-outer-background   "#de935f")
      ...
      (replace-outer-foreground  "#282a2e") (replace-outer-background  "#b294bb")
  ...
  (airline-themes-set-deftheme 'airline-base16_tomorrow_night)
...
(provide-theme 'airline-base16_tomorrow_night)
;;; airline-base16_tomorrow_night-theme.el ends here
