...
(deftheme airline-base16_mexico_light
...
(let ((normal-outer-foreground   "#e8e8e8") (normal-outer-background   "#585858")
      ...
      (insert-outer-foreground   "#e8e8e8") (insert-outer-background   "#538947")
      ...
      (replace-outer-foreground  "#e8e8e8") (replace-outer-background  "#96609e")
  ...
  (airline-themes-set-deftheme 'airline-base16_mexico_light)
...
(provide-theme 'airline-base16_mexico_light)
;;; airline-base16_mexico_light-theme.el ends here
