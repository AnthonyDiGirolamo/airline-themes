...
(deftheme airline-base16_classic_dark
...
(let ((normal-outer-foreground   "#202020") (normal-outer-background   "#B0B0B0")
      ...
      (insert-outer-foreground   "#202020") (insert-outer-background   "#90A959")
      ...
      (visual-outer-foreground   "#202020") (visual-outer-background   "#D28445")
      ...
      (replace-outer-foreground  "#202020") (replace-outer-background  "#AA759F")
  ...
  (airline-themes-set-deftheme 'airline-base16_classic_dark)
...
(provide-theme 'airline-base16_classic_dark)
;;; airline-base16_classic_dark-theme.el ends here
